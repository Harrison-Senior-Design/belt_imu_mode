...
import screen_library.config as config
from screen_library.display import display
from screen_library.log import logger
...
if HW_SENSORS == "PYTHON":
    import screen_library.sensors.sensors_python as sensors
elif HW_SENSORS == "LHM":
    if platform.system() == 'Windows':
        import screen_library.sensors.sensors_librehardwaremonitor as sensors
    else:
    ...
    import screen_library.sensors.sensors_stub_random as sensors
elif HW_SENSORS == "STATIC":
    logger.warning("Stub sensors, not real HW sensors")
    import screen_library.sensors.sensors_stub_static as sensors
